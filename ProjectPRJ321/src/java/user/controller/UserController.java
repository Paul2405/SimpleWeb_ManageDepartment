...
public class UserController extends HttpServlet {
    ...
    private static final String SEARCH = "SearchDeviceUserController";
    ...
    private static final String NOTIFICATION = "GetNotificationController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action.equals("Search")) {
                ...
                url = HISTORY;
            } else if (action.equals("Request to repair")) {
                url = REQUEST;

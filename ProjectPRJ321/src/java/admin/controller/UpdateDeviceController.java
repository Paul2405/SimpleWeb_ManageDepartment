...
public class UpdateDeviceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DeviceDTO dto = dao.getDeviceByID(id);
            request.setAttribute("UPDEViCE", dto);
        } catch (Exception e) {
            log("ERROR at UpdateDeviceController: " + e.getMessage());
        }finally{
            request.getRequestDispatcher("admin/updateDevice.jsp").forward(request, response);
        }
    }

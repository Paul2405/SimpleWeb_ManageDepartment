 ...
 * @author PauL
 */
public class DetailLocationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at DetailLocationController: " + e.getMessage());
        } finally {
            request.getRequestDispatcher("admin/locationDevice.jsp").forward(request, response);
        }
    }
